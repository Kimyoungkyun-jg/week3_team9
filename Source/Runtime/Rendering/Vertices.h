...
struct FVertexInstanceLayouts {
  static inline const D3D11_INPUT_ELEMENT_DESC Layout[] = {
      ...
      // 슬롯 2 : 인스턴스 데이터 (MVP)
      {"INSTANCE_WORLDMODEL", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 64,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_WORLDMODEL", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 80,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_WORLDMODEL", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 96,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_WORLDMODEL", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 112,D3D11_INPUT_PER_INSTANCE_DATA, 1},

      {"INSTANCE_COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 128,D3D11_INPUT_PER_INSTANCE_DATA, 1},

      {"INSTANCE_UV_SCALE", 0, DXGI_FORMAT_R32G32_FLOAT, 1, 144,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_UV_OFFSET", 0, DXGI_FORMAT_R32G32_FLOAT, 1, 152,D3D11_INPUT_PER_INSTANCE_DATA, 1},
  };
  static constexpr UINT NumElements = 15;
};

struct FVertexInstancedBillboardLayouts {
  static inline const D3D11_INPUT_ELEMENT_DESC Layout[] = {
      {"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0},
      {"COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0},
      {"TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 28,D3D11_INPUT_PER_VERTEX_DATA, 0},
      ...
      {"INSTANCE_CENTER", 0, DXGI_FORMAT_R32G32B32_FLOAT, 1, 80,D3D11_INPUT_PER_INSTANCE_DATA, 1},

      {"INSTANCE_SIZE", 0, DXGI_FORMAT_R32G32_FLOAT, 1, 92,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_UV_SCALE", 0, DXGI_FORMAT_R32G32_FLOAT, 1, 100,D3D11_INPUT_PER_INSTANCE_DATA, 1},
      {"INSTANCE_UV_OFFSET", 0, DXGI_FORMAT_R32G32_FLOAT, 1, 108,D3D11_INPUT_PER_INSTANCE_DATA, 1},
  };
  static constexpr UINT NumElements = 13;
};
